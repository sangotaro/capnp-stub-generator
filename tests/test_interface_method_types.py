...
class TestCalculatorInterfaceMethodTypes:
    ...
    def test_getoperator_has_enum_parameter(self, generate_calculator_stubs):
        ...
        # Should have getOperator with enum parameter as CalculatorOperatorEnum (wide union)
...
class TestInterfaceMethodComplexTypes:
    ...
    def test_struct_parameter_types(self, generate_calculator_stubs):
        ...
        assert "expression: CalculatorExpressionBuilder | CalculatorExpressionReader" in stub_content
        assert "body: CalculatorExpressionBuilder | CalculatorExpressionReader" in stub_content
