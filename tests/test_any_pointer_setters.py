...
def test_any_pointer_setters(basic_stubs):
    ...
    assert "def s(self, value: AnyStruct | dict[str, typing.Any]) -> None: ..." in content

    # l setter should accept list builder/reader/Sequence
    assert "def l(self, value: AnyList | Sequence[typing.Any]) -> None: ..." in content

    # Check new_message
    assert "any: AnyPointer | None = None" in content
    assert "s: AnyStruct | dict[str, typing.Any] | None = None" in content
    assert "l: AnyList | Sequence[typing.Any] | None = None" in content
